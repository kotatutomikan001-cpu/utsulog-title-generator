...
def generate_nickname(comments):
    ...
    if len(top_tier_words) >= 3:
        ...
        special_templates = [
            ...
            f"【{t1}の書巻を広げ{t2}をしたため{t3}を語り継ぐマスター】",
        ]
    ...
    if count1 >= 40:
        ...
        templates = [
            f"【{top1}を白銀に刻み{top2}の物語をしたためる覇王】",
        ...
        templates = [
            ...
            f"【{top1}の氷晶を抱き{top2}の物語をしたためる職人】",
            f"【{top1}の原稿用紙に{top2}の想いを走らせるマスター】",
            f"【{top1}の書簡をしたため{top2}への愛を語る編纂者】",
            f"【{top1}を冴えた筆先で捉え{top2}の詩をしたためる探求者】",
        ...
        templates = [
            ...
            f"【{top1}のメモ帳を開き{top2}を小さくしたためる新星】",
...
if "title" in st.session_state:
    ...
    with btn_col2:
        # ★ 静的な OGP を保持した GitHub Pages の URL（末尾に ?v=2 を付与してXのキャッシュを強制更新）
        share_app_url = "https://kotatutomikan001-cpu.github.io/utsulog-title-generator/?v=2"
